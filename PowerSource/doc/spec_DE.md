...
Global description: **Energiequelle eines Infrastrukturelements.**  
...
#### Stromquelle NGSI-v2 normalisiertes Beispiel  

Hier ist ein Beispiel für eine PowerSource im JSON-Format als normalisiert. Dies ist kompatibel mit NGSI-v2, wenn keine Optionen verwendet werden und gibt die Kontextdaten einer einzelnen Entität zurück.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### Energiequelle NGSI-LD Schlüssel-Wert-Beispiel  

Hier ist ein Beispiel für eine PowerSource im JSON-LD-Format als Schlüssel-Werte. Dies ist kompatibel mit NGSI-LD, wenn `options=keyValues` verwendet wird und die Kontextdaten einer einzelnen Entität zurückgegeben werden.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### Stromquelle NGSI-LD normalisiertes Beispiel  

Hier ist ein Beispiel für eine PowerSource im JSON-LD-Format als normalisiert. Dies ist kompatibel mit NGSI-LD, wenn keine Optionen verwendet werden und es die Kontextdaten einer einzelnen Entität zurückgibt.  
<details><summary><strong>show/hide example</strong></summary>    
