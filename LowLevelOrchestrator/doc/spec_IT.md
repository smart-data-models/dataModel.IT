...
[Licenza aperta](https://github.com/smart-data-models//dataModel.IT/blob/master/LowLevelOrchestrator/LICENSE.md)  
...
- `type[string]`: Tipo di entità NGSI. Deve essere LowLevelOrchestrator  
<!-- /30-PropertiesList -->
...
#### LowLevelOrchestrator esempio di valori chiave NGSI-LD  

Ecco un esempio di LowLevelOrchestrator in formato JSON-LD come chiavi-valori. Ciò è compatibile con NGSI-LD quando si utilizza `options=keyValues` e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>show/hide example</strong></summary>    
