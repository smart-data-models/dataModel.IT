...
[Licencia Abierta](https://github.com/smart-data-models//dataModel.IT/blob/master/Domain/LICENSE.md)  
...
Global description: **Dominio del continuo de computación Cloud-Edge-IoT, que está compuesto por un conjunto de ElementosDeInfraestructura**  
...
- `domainStatus[string]`: Enum:'Preliminar', 'Funcional', 'Eliminado', 'NoConfiado'. Estado actual del dominio.  
- `id[*]`: Identificador único de la entidad  
- `isEntrypoint[boolean]`: Define si este dominio es el dominio de punto de entrada del continuo.  
...
- `publicKey[string]`: Clave pública (WireGuard) codificada en base64 del dominio.  
- `publicUrl[string]`: URL pública del dominio, que debe apuntar a su API expuesta.  . Model: [https://schema.org/URL](https://schema.org/URL)  
...
- `type[string]`: Tipo de entidad NGSI. Tiene que ser Dominio  
<!-- /30-PropertiesList -->
...
#### Dominio NGSI-v2 clave-valor Ejemplo  

Aquí hay un ejemplo de un Dominio en formato JSON como clave-valor. Esto es compatible con NGSI-v2 cuando se utiliza `options=keyValues` y devuelve los datos de contexto de una entidad individual.  
...
#### Dominio NGSI-v2 normalizado Ejemplo  

Aquí hay un ejemplo de un Dominio en formato JSON normalizado. Esto es compatible con NGSI-v2 cuando no se utilizan opciones y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### Dominio NGSI-LD clave-valor Ejemplo  

Aquí hay un ejemplo de un Dominio en formato JSON-LD como clave-valor. Esto es compatible con NGSI-LD cuando se utiliza `options=keyValues` y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### Dominio NGSI-LD normalizado Ejemplo  

Aquí hay un ejemplo de un Dominio en formato JSON-LD normalizado. Esto es compatible con NGSI-LD cuando no se utilizan opciones y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>show/hide example</strong></summary>    
