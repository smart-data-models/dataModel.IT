...
[Licenza aperta](https://github.com/smart-data-models//dataModel.IT/blob/master/Service/LICENSE.md)  
...
Global description: **Servizio distribuito nel continuum Cloud-Edge-IoT, che è composto da un set di ServiceComponents in esecuzione sopra gli InfrastructureElements.**  
...
- `actionType[string]`: Enum: 'Distribuzione', 'Distribuito', 'Distruzione', 'Completato', 'Gestito'. Stato attuale dell'intero servizio nel processo di orchestrazione.  
...
- `domainHandler[string]`: Dominio che è responsabile dell'esecuzione del processo di orchestrazione del servizio.  
- `hasOverlay[boolean]`: Definisce se i componenti di questo servizio sono connessi attraverso una rete sovrapposta.  
...
- `serviceType[string]`: Tipo del servizio distribuito, che deve essere un'entità ServiceType.  
...
- `type[string]`: Tipo di entità NGSI. Deve essere Servizio  
<!-- /30-PropertiesList -->
...
#### Servizio NGSI-v2 valori chiave Esempio  

Ecco un esempio di un Servizio in formato JSON come chiavi-valori. Ciò è compatibile con NGSI-v2 quando si utilizza `options=keyValues` e restituisce i dati di contesto di un'entità individuale.  
...
#### Servizio NGSI-v2 normalizzato Esempio  

Ecco un esempio di un Servizio in formato JSON come normalizzato, compatibile con NGSI-v2 quando non si utilizzano opzioni e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### Servizio NGSI-LD chiave-valori Esempio  

Ecco un esempio di un Servizio in formato JSON-LD come chiavi-valori. Ciò è compatibile con NGSI-LD quando si utilizza `options=keyValues` e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### Servizio NGSI-LD normalizzato Esempio  

Ecco un esempio di un Servizio in formato JSON-LD normalizzato, compatibile con NGSI-LD quando non si utilizzano opzioni e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>show/hide example</strong></summary>    
