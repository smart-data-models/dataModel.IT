...
[Licenza aperta](https://github.com/smart-data-models//dataModel.IT/blob/master/NetworkConnection/LICENSE.md)  
...
Global description: **Modello di dati per una connessione di rete tra due ServiceComponent**  
...
<sup><sub>[*] Se non c'è un tipo in un attributo è perché potrebbe avere più tipi o formati/modello diversi</sub></sup>  
...
- `linkFrom[string]`: ServiceComponent che deve stabilire una connessione di rete con il componente 'linkTo'  
- `linkTo[string]`: ServiceComponent che espone alcune porte di rete che devono essere utilizzate dal componente 'linkFrom'  
...
- `networkPorts[array]`: Porte di rete esposte dal componente 'linkTo' e utilizzate dal componente 'linkFrom'  
...
- `status[string]`: Enum: 'Su', 'Giù'. Stato della connessione  
- `type[string]`: Tipo di entità NGSI. Deve essere NetworkConnection  
<!-- /30-PropertiesList -->
...
#### Connessione di rete NGSI-v2 esempio di valori chiave  

Ecco un esempio di NetworkConnection in formato JSON come chiavi-valori. Ciò è compatibile con NGSI-v2 quando si utilizza `options=keyValues` e restituisce i dati di contesto di un'entità individuale.  
...
#### ConnessioneRete NGSI-v2 normalizzato Esempio  

Ecco un esempio di NetworkConnection in formato JSON come normalizzato. Ciò è compatibile con NGSI-v2 quando non si utilizzano opzioni e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### Connessione di rete Esempio di valori chiave NGSI-LD  

Ecco un esempio di NetworkConnection in formato JSON-LD come valori chiave. Ciò è compatibile con NGSI-LD quando si utilizza `options=keyValues` e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### ConnessioneRete Esempio NGSI-LD normalizzato  

Ecco un esempio di NetworkConnection in formato JSON-LD come normalizzato. Ciò è compatibile con NGSI-LD quando non si utilizzano opzioni e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>show/hide example</strong></summary>    
