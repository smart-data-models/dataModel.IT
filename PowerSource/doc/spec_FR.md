...
[Licence ouverte](https://github.com/smart-data-models//dataModel.IT/blob/master/PowerSource/LICENSE.md)  
...
Global description: **Source d'alimentation d'un élément d'infrastructure.**  
...
- `currentPowerGeneratorPotential[number]`: Potentiel actuel du générateur d'énergie.  
- `dataProvider[string]`: Une séquence de caractères identifiant le fournisseur de l'entité de données harmonisées  
- `dateCreated[date-time]`: Horodatage de création d'entité. Celui-ci est généralement alloué par la plateforme de stockage  
...
- `greenEnergyRatio[number]`: Rapport (entre 0 et 1) d'énergie verte utilisée par la source d'alimentation.  
...
- `type[string]`: Type d'entité NGSI. Il doit s'agir de PowerSource  
<!-- /30-PropertiesList -->
...
#### Exemple de clés-valeurs PowerSource NGSI-v2  

Voici un exemple de PowerSource au format JSON en tant que clés-valeurs. Ceci est compatible avec NGSI-v2 lors de l'utilisation de `options=keyValues` et retourne les données de contexte d'une entité individuelle.  
...
#### Exemple PowerSource NGSI-v2 normalisé  

Voici un exemple d'une PowerSource au format JSON normalisé. Ceci est compatible avec NGSI-v2 lorsqu'il n'utilise pas d'options et retourne les données de contexte d'une entité individuelle.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### Exemple de clés-valeurs PowerSource NGSI-LD  

Voici un exemple de PowerSource au format JSON-LD sous forme de paires clé-valeur. Ceci est compatible avec NGSI-LD lors de l'utilisation de `options=keyValues` et retourne les données de contexte d'une entité individuelle.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### Exemple normalisé PowerSource NGSI-LD  

Voici un exemple d'une PowerSource au format JSON-LD normalisé. Ceci est compatible avec NGSI-LD lorsqu'il n'utilise pas d'options et retourne les données de contexte d'une entité individuelle.  
<details><summary><strong>show/hide example</strong></summary>    
...
notes figurant dans le pied de page de la spécification  
<!-- /90-FooterNotes -->
