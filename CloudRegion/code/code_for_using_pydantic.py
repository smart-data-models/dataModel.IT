...
class PointsOfContactItem(BaseModel):
...
class CloudRegion(BaseModel):
    ...
    cloudName: Optional[str] = Field(
        None, description='Name assigned to the corresponding region'
    )
    ...
    pointsOfContact: Optional[List[PointsOfContactItem]] = Field(
        None, description='List of contact points of the cloud region'
    )
    ...
    test: Optional[AnyUrl] = Field(
        None, description='Identification of the tests executed'
    )
    type: Optional[Type6] = Field(
        None, description='NGSI Entity type. It has to be CloudRegion'
    )
    version: Optional[str] = Field(
        None, description='Corresponding Cloud version of the region'
    )
