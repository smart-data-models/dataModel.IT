...
class ITTests(BaseModel):
    ...
    component: Optional[AnyUrl] = Field(
        None,
    ...
    elapsedTime: Optional[confloat(ge=0.0, multiple_of=1.0)] = Field(
        None,
    ...
    tests: Optional[List[Test]] = Field(
        None, description='Status of the execution of each of the tests'
    )
    timestamp: Optional[confloat(ge=0.0, multiple_of=1.0)] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI Entity type. It has to be ITTests'
    )
