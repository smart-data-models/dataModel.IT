...
[Licence ouverte](https://github.com/smart-data-models//dataModel.IT/blob/master/ServiceType/LICENSE.md)  
...
Global description: **Service catalogué pouvant être déployé dans le continuum Cloud-Edge-IoT.**  
...
- `license[string]`: Licence sous laquelle le service répertorié est fourni.  
...
- `type[string]`: Type d'entité NGSI. Il doit s'agir de ServiceType  
- `webPage[string]`: Lien vers la page web du service répertorié.  . Model: [https://schema.org/URL](https://schema.org/URL)  
<!-- /30-PropertiesList -->
...
#### Type de service Clés-valeurs NGSI-v2 Exemple  

Voici un exemple de ServiceType au format JSON sous forme de paires clé-valeur. Ceci est compatible avec NGSI-v2 lors de l'utilisation de `options=keyValues` et retourne les données de contexte d'une entité individuelle.  
...
#### Type de service NGSI-v2 normalisé Exemple  

Voici un exemple de ServiceType au format JSON normalisé. Ceci est compatible avec NGSI-v2 lorsqu'il n'utilise pas d'options et renvoie les données de contexte d'une entité individuelle.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### Type de service clés-valeurs NGSI-LD Exemple  

Voici un exemple de ServiceType au format JSON-LD sous forme de paires clé-valeur. Ceci est compatible avec NGSI-LD lors de l'utilisation de `options=keyValues` et retourne les données de contexte d'une entité individuelle.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### Type de service NGSI-LD normalisé Exemple  

Voici un exemple d'un ServiceType au format JSON-LD normalisé. Ceci est compatible avec NGSI-LD lorsqu'il n'utilise pas d'options et retourne les données de contexte d'une entité individuelle.  
<details><summary><strong>show/hide example</strong></summary>    
