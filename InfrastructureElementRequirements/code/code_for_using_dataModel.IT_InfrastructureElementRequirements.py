...
dataModel = "InfrastructureElementRequirements"
subject = "dataModel.IT"
requiredCpuUsage = 0.2
attribute = "requiredCpuUsage"
value = requiredCpuUsage
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

requiredMemoryUsage = 4096
attribute = "requiredMemoryUsage"
value = requiredMemoryUsage
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

cpuArchitecture = "AMD64"
attribute = "cpuArchitecture"
