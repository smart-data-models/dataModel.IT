...
pointsOfContact = [{'email': 'theron31@quigley.net'}, {'email': 'qhuel@gmailo.com'}, {'email': 'tania88@pfeffer.com'}, {'email': 'salvador.jacobson@hotmalil.com'}, {'email': 'uriel08@blick.com'}]
attribute = "pointsOfContact"
