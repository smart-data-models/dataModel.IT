...
Entidad: InfrastructureElementRequirements  
=========================================
<!-- /10-Header -->
...
[Licencia Abierta](https://github.com/smart-data-models//dataModel.IT/blob/master/InfrastructureElementRequirements/LICENSE.md)  
...
Global description: **Requisitos de cómputo que debe cumplir un InfrastructureElement para ejecutar un determinado ServiceComponent en él.**  
...
- `address[object]`: La dirección de correo  . Model: [https://schema.org/address](https://schema.org/address)  
	...
	- `addressLocality[string]`: La localidad en la cual está la dirección de la calle, y que está en la región  . Model: [https://schema.org/addressLocality](https://schema.org/addressLocality)    
...
- `diskType[string]`: Enum:'HDD', 'SSD'. Tipo de disco que debe tener el Elemento de Infraestructura.  
- `energyEfficiencyRatio[float]`: Relación de eficiencia energética (entre 0 y 1) que debe tener el Elemento de Infraestructura.  
- `gpu[boolean]`: Define si el Elemento de Infraestructura debe tener una GPU.  
- `greenEnergyRatio[float]`: Relación (entre 0 y 1) de energía verde que debe utilizar la fuente de alimentación que alimenta el Elemento de Infraestructura.  
- `id[*]`: Identificador único de la entidad  
- `infrastructureElement[string]`: Solo si un InfrastructureElement específico ha sido seleccionado para ejecutar el componente.  
...
- `realTimeCapable[boolean]`: Define si el Elemento de Infraestructura debe ser capaz de procesamiento en tiempo real.  
- `requiredCpuUsage[float]`: Uso de CPU requerido del componente.  
- `requiredMemoryUsage[number]`: Uso de memoria requerido del componente.  
...
- `type[string]`: Tipo de entidad NGSI. Tiene que ser InfrastructureElementRequirements  
<!-- /30-PropertiesList -->
...
#### RequisitosDeElementosDeInfraestructura clave-valor NGSI-v2 Ejemplo  

Aquí hay un ejemplo de InfrastructureElementRequirements en formato JSON como clave-valor. Esto es compatible con NGSI-v2 cuando se utiliza `options=keyValues` y devuelve los datos de contexto de una entidad individual.  
...
#### RequisitosDeElementosDeInfraestructura NGSI-v2 normalizado Ejemplo  

Aquí hay un ejemplo de InfrastructureElementRequirements en formato JSON normalizado. Esto es compatible con NGSI-v2 cuando no se utilizan opciones y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### Requisitos de Elementos de Infraestructura clave-valor de ejemplo NGSI-LD  

Aquí hay un ejemplo de InfrastructureElementRequirements en formato JSON-LD como clave-valor. Esto es compatible con NGSI-LD cuando se utiliza `options=keyValues` y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### RequisitosDeElementosDeInfraestructura NGSI-LD normalizado Ejemplo  

Aquí hay un ejemplo de InfrastructureElementRequirements en formato JSON-LD normalizado. Esto es compatible con NGSI-LD cuando no se utilizan opciones y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>show/hide example</strong></summary>    
