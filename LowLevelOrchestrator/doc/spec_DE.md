...
[Offene Lizenz](https://github.com/smart-data-models//dataModel.IT/blob/master/LowLevelOrchestrator/LICENSE.md)  
...
Global description: **Ein Low-Level-Orchestrator der Domäne, der mit einem eindeutigen Orchestrierungstyp (z. B. Kubernetes, Docker, containerd usw.) verknüpft ist.**  
...
#### LowLevelOrchestrator NGSI-v2 normalisiertes Beispiel  

Hier ist ein Beispiel für einen LowLevelOrchestrator im JSON-Format als normalisiert. Dies ist kompatibel mit NGSI-v2, wenn keine Optionen verwendet werden und gibt die Kontextdaten einer einzelnen Entität zurück.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### LowLevelOrchestrator NGSI-LD normalisiertes Beispiel  

Hier ist ein Beispiel für einen LowLevelOrchestrator im JSON-LD-Format als normalisiert. Dies ist kompatibel mit NGSI-LD, wenn keine Optionen verwendet werden und gibt die Kontextdaten einer einzelnen Entität zurück.  
<details><summary><strong>show/hide example</strong></summary>    
