...
[Licencia Abierta](https://github.com/smart-data-models//dataModel.IT/blob/master/ServiceType/LICENSE.md)  
...
Global description: **Servicio catalogado que se puede implementar en el continuo Cloud-Edge-IoT.**  
...
- `license[string]`: Licencia bajo la cual se proporciona el servicio catalogado.  
...
- `type[string]`: Tipo de entidad NGSI. Tiene que ser ServiceType  
- `webPage[string]`: Enlace a la página web del servicio catalogado.  . Model: [https://schema.org/URL](https://schema.org/URL)  
<!-- /30-PropertiesList -->
...
#### TipoDeServicio clave-valor NGSI-v2 Ejemplo  

Aquí hay un ejemplo de un ServiceType en formato JSON como clave-valor. Esto es compatible con NGSI-v2 cuando se utiliza `options=keyValues` y devuelve los datos de contexto de una entidad individual.  
...
#### TipoDeServicio NGSI-v2 normalizado Ejemplo  

Aquí hay un ejemplo de un ServiceType en formato JSON normalizado. Esto es compatible con NGSI-v2 cuando no se utilizan opciones y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### TipoDeServicio clave-valor NGSI-LD Ejemplo  

Aquí hay un ejemplo de un ServiceType en formato JSON-LD como clave-valor. Esto es compatible con NGSI-LD cuando se utiliza `options=keyValues` y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### TipoDeServicio NGSI-LD normalizado Ejemplo  

Aquí hay un ejemplo de un ServiceType en formato JSON-LD normalizado. Esto es compatible con NGSI-LD cuando no se utilizan opciones y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>show/hide example</strong></summary>    
