...
attribute = "serviceComponentStatus"
value = serviceComponentStatus
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

infrastructureElementRequirements = "urn:ngsi-ld:Service:WebApp01:Component:Backend:InfrastructureElementRequirements"
attribute = "infrastructureElementRequirements"
value = infrastructureElementRequirements
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))
