...
Global description: **Un orchestrateur de bas niveau du domaine, qui est associé à un type d'orchestration unique (par exemple, Kubernetes, Docker, containerd, etc.).**  
...
#### Orchestrateur de bas niveau exemple normalisé NGSI-LD  

Voici un exemple de LowLevelOrchestrator au format JSON-LD normalisé. Ceci est compatible avec NGSI-LD lorsqu'il n'utilise pas d'options et retourne les données de contexte d'une entité individuelle.  
<details><summary><strong>show/hide example</strong></summary>    
