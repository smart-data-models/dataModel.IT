...
[Licenza aperta](https://github.com/smart-data-models//dataModel.IT/blob/master/NetworkPort/LICENSE.md)  
...
Global description: **Porta di rete esposta da un ServiceComponent.**  
...
- `number[number]`: Numero della porta di rete.  
...
- `protocol[string]`: Protocollo della porta di rete. Enum: 'TCP', 'UDP', 'SCTP'  
...
- `type[string]`: Tipo di entità NGSI. Deve essere NetworkPort  
<!-- /30-PropertiesList -->
...
#### Porta di rete NGSI-v2 esempio di valori chiave  

Ecco un esempio di NetworkPort in formato JSON come chiavi-valori. Ciò è compatibile con NGSI-v2 quando si utilizza `options=keyValues` e restituisce i dati di contesto di un'entità individuale.  
...
#### Porta di rete NGSI-v2 normalizzato Esempio  

Ecco un esempio di NetworkPort in formato JSON come normalizzato. Ciò è compatibile con NGSI-v2 quando non si utilizzano opzioni e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### Chiave di rete NGSI-LD valori Esempio  

Ecco un esempio di NetworkPort in formato JSON-LD come chiavi-valori. Ciò è compatibile con NGSI-LD quando si utilizza `options=keyValues` e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### Porta di rete NGSI-LD normalizzato Esempio  

Ecco un esempio di NetworkPort in formato JSON-LD come normalizzato, compatibile con NGSI-LD quando non si utilizzano opzioni e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>show/hide example</strong></summary>    
