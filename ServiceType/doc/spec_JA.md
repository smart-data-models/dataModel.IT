...
[オープンライセンス](https://github.com/smart-data-models//dataModel.IT/blob/master/ServiceType/LICENSE.md)  
...
Global description: **クラウド・エッジ・IoTの連続体で展開できるサービスをカタログ化する。**  
...
- `address[object]`: 郵送先住所  . Model: [https://schema.org/address](https://schema.org/address)  
	...
	- `postOfficeBoxNumber[string]`: ポストオフィスボックス番号は、ポストオフィスボックスの住所の場合。例えば、03578  . Model: [https://schema.org/postOfficeBoxNumber](https://schema.org/postOfficeBoxNumber)    
...
- `id[*]`: エンティティの固有識別子  
- `license[string]`: カタログ化されたサービスが提供されるライセンス。  
...
- `type[string]`: NGSIエンティティタイプ。ServiceTypeでなければなりません。  
- `webPage[string]`: カタログ化されたサービスへのウェブページへのリンク。  . Model: [https://schema.org/URL](https://schema.org/URL)  
<!-- /30-PropertiesList -->
...
#### サービスタイプ NGSI-v2 キー値の例  

ここでは、キーと値のペアとしてJSON形式のServiceTypeの例を示します。これは、`options=keyValues`を使用してNGSI-v2と互換性があり、個々のエンティティのコンテキストデータを返します。  
...
#### サービスタイプ NGSI-v2 正規化 例  

ここは、正規化されたJSON形式のServiceTypeの例です。これは、オプションを使用しない場合、NGSI-v2と互換性があり、個々のエンティティのコンテキストデータを返します。  
<details><summary><strong>show/hide example</strong></summary>    
...
#### サービスタイプ NGSI-LD キー値の例  

ここはJSON-LD形式のServiceTypeの例です。key-valuesとして。NGSI-LDと互換性があり、`options=keyValues`を使用して個々のエンティティのコンテキストデータを返します。  
<details><summary><strong>show/hide example</strong></summary>    
...
#### サービスタイプ NGSI-LD 正規化 例  

ここでは、正規化されたJSON-LD形式のServiceTypeの例を示します。これは、オプションを使用しない場合、NGSI-LDと互換性があり、個々のエンティティのコンテキストデータを返します。  
<details><summary><strong>show/hide example</strong></summary>    
